...
const Footer = () => {
  return (
    <div>
<<<<<<< HEAD
    <footer style={{backgroundColor:"#041e48"}} className=" w-screen">
      <div
        className="mx-auto max-w-screen space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8"
      >
...
=======
      ...
      <footer style={{ backgroundColor: '#041e48' }} className= "text-gray-200 bg-gray-300 font-black  body-font w-screen">
        <div className="container px-5 py-10 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-80 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mr-30">
          ...
          <div className=" py-4 flex flex-wrap flex-col sm:flex-row">
            {/* // move this below the social media handles. align centre and the icon size 15/16  */}
            <p className="text-gray-400 text-sm text-center sm:text-center">© 2023 All Rights Reserved —
          ...
          <div className="flex-grow flex flex-wrap -mb-10 md:text-left mt-4 text-center ml-7">
...
=======
                <li className="mb-3">
                  <a href="/faq" className= "text-gray-200 font-black  hover:text-blue-600 cursor-pointer mb-2"><span className= 'text-gray-200'>&#9830;</span> FAQ</a>
                </li>
              </nav>
>>>>>>> 1b31501d6525ca121250d7dfee53d64b933c9bba
            </div>
            <div>
              <p className="text-lg underline decoration-yellow-400 underline-offset-8 text-white">Participate</p>
            ...
            <div>
              <p className="text-lg underline decoration-yellow-400 underline-offset-8 text-white">Company</p>
            ...
            <div>
              <p className="text-lg underline decoration-yellow-400 underline-offset-8 text-white">Helpful Links</p>
