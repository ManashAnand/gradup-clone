    ...
    <section className='w-screen flex justify-around headingbox'>
      <div className="my-12 flex flex-col justify-center">
        ...
        <Link href='/courses' className="area">
              <button className='rounded-2xl py-1 px-6 border-2 textnew border-blue-500 bg-white text-blue-700 mt-6 mb-10 hover:bg-sky-400 hover:text-white hover:border-white'>Let's Discuss</button>
        </Link>
        </div> 
