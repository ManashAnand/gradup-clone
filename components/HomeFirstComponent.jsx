    ...
    <section className='w-screen flex justify-between headingbox'>
      ...
      <div className="mb-6 z-10 flex flex-col justify-center">
        ...
        <div className=' text-left text-white textnew'>
            <h1 className='mt-6 sm:text-xl mb-6'>The ultimate platform for college-to-career success, offering skill-suited internships, upskilling courses, and expert guidance all in one place.</h1> 
        </div>
