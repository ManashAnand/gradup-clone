...
const HomeFirstComponent = () => {
  ...
  return (
    <section className={`w-screen flex justify-between ${styles["headingbox"]}`}>
      ...
      <div className='mb-6 z-10 flex flex-col justify-center'>
        ...
        <div
          ...
          className={`text-2xl sm:text-5xl text-white ${styles["textnew"]} text-left`}
        >
          <p className=''>Connecting talent to</p>
          <p style={{ overflow: 'hidden' }} className=''>
            Explore new{' '}
            <span className={`${styles["animate-charcter"]} font-semibold`}>
              Opportunities
            </span>
          </p>
        </div>
        <div className={`text-left text-white ${styles["textnew"]}`}>
          <h1 className='mt-6 sm:text-xl mb-6'>
            The ultimate platform for college-to-career success, offering
            skill-suited internships, jobs, upskilling courses and expert
        ...
        {session?.user.id ? (
          ...
          <>
            ...
            <div>
              <Link href='/loginuser'>
                <button className={`${styles["animated-button1"]}  rounded-2xl py-1 px-6 ${styles["textnew"]}`}>
                  <span></span>
                  <span></span>
                  <span></span>
                  <span></span>
      ...
      <div className={`${styles["hideimage"]} z-10 grid grid-cols-2 my-auto gap-4`}>
