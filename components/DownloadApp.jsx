...
export default function Download(){
    return(
        <div style={{background:"linear-gradient(260deg, rgba(126, 207, 90, 0.94) 0%, rgba(4, 78, 131, 0.98) 35.32%, rgba(4, 78, 131, 0.97) 20.79%, rgba(4, 78, 131, 0.96) 27.13%, rgba(4, 78, 131, 0.95) 60.90%, rgba(126, 207, 90, 0.94) 99.86%)"}}
