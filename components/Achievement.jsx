  ...
  return (
       <div className="achievementbox w-screen justify-center items-center">
            ...
            <div className="w-48 h-28 datamile1 pt-2">
              ...
              <p className="text-xs font-semibold text-white text-center mb-1">YEARS IN BUSINESS</p>
            ...
            <div className="w-48 h-28 datamile1 pt-2">
            <h1 className="text-4xl text-center text-white font-semibold">15000+</h1>
              <p className="text-xs font-semibold text-white text-center mb-1">NUMBER OF STUDENTS</p>
            ...
            <h1 className="text-4xl text-center text-white font-semibold">100+</h1>
              <p className="text-xs font-semibold text-white text-center mb-1">INSTITUTES IN TOUCH</p>
