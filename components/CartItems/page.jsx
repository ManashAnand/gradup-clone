...
import login from '../../public/serviceasset/asset2.jpg'
...
async function CartItems() {
  ...
  const handleDeleteOneItem =  (title) => {
  ...
  return (
    <>
      {
        CartData?.record?.map((cartBook) => {
                    return(
                        <div key={cartBook?.title}>
                ...
                <div className="  flex justify-center items-center flex-col xl:w-[20%] ">
                    <img src="" alt="book cover" className="w-[6rem] h-[6rem] rounded-md border border-white"/>
                ...
                <div className="  xl:w-[40%] p-2  rounded-md border border-white xl:h-3/5 xl:p-0 xl:mt-8">
                    ...
                    <div className=" flex justify-around items-center xl:h-[45%]">
                    ₹{cartBook?.price}
                        <span className="text-red-500 cursor-pointer" onClick={() => handleDeleteOneItem(cartBook?.title)}>
