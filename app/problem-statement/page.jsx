...
const page = () => {
  return (
    <div className='w-screen mb-6'>
      <p className='text-4xl font-semibold textnew text-white text-center mt-14'>Solution to the Problem statement !!</p>
    <div className={styles.content}>
      <h1 className='text-green-300 text-left text-3xl mt-6 mb-8'>Challenges of Finding Quality Internships</h1>
      <p className='text-white justice textnew'>Finding quality internships is a major challenge for students in
      ...
      internships and businesses to find the right interns.</p>

      <h1 className='text-green-300 text-left text-3xl mt-12 mb-8'>Simplifying the
      Internship Process</h1>
      <p className='text-white justice textnew'>GradUp is a comprehensive platform that simplifies the internship
