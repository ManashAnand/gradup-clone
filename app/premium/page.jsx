    ...
    return (
        <div className="w-screen textform">
            <div id="premium" className="flex flex-col justify-center items-center bg-blue-600 p-6">
                ...
                <p className="text-white text-3xl mt-3">Post <span className="underlined">unlimited</span> premium internships and jobs</p>
            ...
            <div className="bg-white pt-10 p-6">
                ...
                <div class="table">
                    ...
                    <div class="table-cell cell-feature">Best-in-class product offering a comprehensive suite of features, including interview scheduling and assignment tools.</div>
                    ...
                    <div class="table-cell cell-feature">Number of internship or job listings in a month</div>
                    <div class="table-cell">
                    ...
                    <div class="table-cell cell-feature">Maximized visibility for all posts.</div>
                    <div class="table-cell">
                    ...
                    <div class="table-cell cell-feature">Efficient database retrieval for every internship and job opening.</div>
                    <div class="table-cell">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="limegreen" class="bi bi-x" viewBox="0 0 15 15">
                            <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z" />
                        </svg>
                    ...
                    <div class="table-cell cell-feature">Unlock premium perks, such as access to contact details and the ability to export data to Excel.</div>
                    <div class="table-cell">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="limegreen" class="bi bi-x" viewBox="0 0 15 15">
                            <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z" />
                        </svg>
                    ...
                    <div class="table-cell cell-feature">CV Building, Mentorship and Skill enhancement </div>
                    <div class="table-cell">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="limegreen" class="bi bi-x" viewBox="0 0 15 15">
                            <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z" />
                        </svg>
