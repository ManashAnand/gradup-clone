...
const page = () => {
  ...
  return (
    <div className="w-full headingbox2 padded4">
        <p className='text-4xl font-semibold animate-charcter text-left underline decoration-white underline-offset-8 mt-2 mb-12 textform text-sky-500'>Sitemap</p>
