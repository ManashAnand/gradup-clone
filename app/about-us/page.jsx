  ...
  return (
    <div>
       ...
       <div className={styles.values}>
        ...
        <div className={styles.core}>
          <div className={styles.contain1}>
            <RocketIcon sx={{color:"rebeccapurple",fontSize:"70px"}} fontSize="large"/>
            <p className="text-blue-900 text-center text-2xl mb-4 font-semibold">Our Mission</p>
          ...
          <div className={styles.contain2}>
            <Diversity2Icon sx={{color:"rebeccapurple",fontSize:"60px"}}/>
            <p className="text-blue-900 text-center text-2xl mb-4 font-semibold">Our Core Values</p>
          ...
          <div className={styles.contain3}>
            <TravelExploreIcon sx={{color:"rebeccapurple",fontSize:"60px"}}/>
            <p className="text-blue-900 text-2xl text-center mb-4 font-semibold">Our Vision</p>
      ...
      <div className="founderbox">
        ...
        <div className="ml-10 mt-7 text">
          <p >Mr. Tanmay is a young and budding entrepreneur who has received the award for India’s Top 100 Emerging Entrepreneurs-2023 by Fox Story India!</p>
          <p >Tanmay has been also featured in many newspapers like Hindustan Times, Hindustan, Outlook, Dainik Bhaskar, Dainik Jagran & many more…</p>
          <p >Tanmay believes in continuous learning for everyone including himself. Currently, Tanmay has been enrolled in Executive Digital Marketing Program at The Wharton School, University of Pennsylvania.</p>
          <p >Tanmay is alumnus of NIT-IIM. He holds an Engineering degree, MBA degree and an Advanced degree in Digital Marketing & Entrepreneurship. Tanmay has worked and collaborated with esteemed companies like PhonePe, Genpact, Toyota, LiuGong, Tata Steel Aashiyana, and PepsiCo (VBL) and has rich experience in framing digital marketing strategies for MSME clients.</p>
          <p >Tanmay is rightly known for his networking and leadership skills. He is presently a member of the International Youth Council, United Nations, and has been elected as the General Secretary and Vice President at various clubs and societies. Before GradUp, Tanmay co-founded a startup namely Business garage which aimed at providing digital marketing strategies to MSMEs.</p>            <p ><em>Tanmay is also a guest speaker, and he has been invited as a guest speaker by many premier institutions of India.</em></p>
          <p ><em>Tanmay has a vision to nurture the youth of “BHARAT” to be industry- and future-ready.</em></p>
          <p ><em>Tanmay’s Director Identification No is  09687950.</em></p>
          <br />
        </div>
      </div>
    </div>
