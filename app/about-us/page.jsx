    ...
    <div>
      ...
      <div className={styles.box}>
        ...
        <div>
          ...
          <p className={styles.para}>Tanmay is rightly known for his networking and leadership skills. He is presently a member of the International Youth Council, United Nations, and has been elected as the General Secretary and Vice President at various clubs and societies. Before GradUp, Tanmay co-founded a startup namely Business garage which aimed at providing digital marketing strategies to MSMEs.</p>            <p className={styles.para}><em>Tanmay is also a guest speaker, and he has been invited as a guest speaker by many premier institutions of India.</em></p>
