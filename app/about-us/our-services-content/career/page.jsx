  ...
  function handleClick5(){
    ...
    return(
        ...
        <div>
          ...
          <p className= {styles.paragraph}>Group Discussion is a crucial step in hiring for corporate jobs where members are assessed for their participation and leadership skills, their ability to take decisions in the stipulated time frame, and their thinking approach. We prepare you to step by step to ACE GD for any company. Comprehensive Course Highlights:</p>
          <h1 className={styles.enroll}>GET FREE GradUp GD Handbook worth Rs. 599/-</h1>
        </div>
      </div>
      ...
      <div className={styles.box}>
        <img className={styles.groupimg1} src="/assets/images/pimodule.jpg" alt="interview"></img>
        <div>
          <h1 className={styles.heading}>--Services</h1>
          <h1 className={styles.subhead}>Personal Interview Module</h1>
          <p className= {styles.paragraph}>Personal Interview is the Ultimate step in hiring for corporate jobs where candidates are the assessed basis of their technical skills, leadership skills, thinking approach, and many others. We prepare you to step by step to ACE PI for any company you sit for.</p>
      ...
      <div className={styles.box}>
        <img className={styles.groupimg2} src="/assets/images/Resumeee.png" alt="interview"></img>
        <div>
          <h1 className={styles.heading}>--Services</h1>
          <h1 className={styles.subhead}>Resume Building</h1>
          <p className= {styles.paragraph}>It is often said that the First impression is the last. We believe that the FIRST IMPRESSION IS THE LASTING IMPRESSION. Your resume is your first face to the company you apply for. Is it good enough? Come get it checked, revised, or even get it built from scratch by our resume-writing experts.</p>
          {/* <button className={styles.btn1}><a href="">Get Service</a></button> */}
        </div>
      </div>
      <div>
        <div className="text-2xl text-white text-center font-semibold mb-12 mt-12">Audio And Video Resumes On Demand</div>
      ...
      <div className={styles.box}>
        <img className={styles.groupimg4} src="/assets/images/corporatecom.png" alt="group"></img>
        <div>
          <h1 className={styles.heading}>--Services</h1>
          <h1 className={styles.subhead}>Winning Corporate Competition</h1>
          <p className= {styles.paragraph}>Being a National Winner in B-School Case Competitions not only adds a star point to your resume but enables you to stand out from the crowd and showcase your real-life problem-solving abilities. Be a part of this 2-hour journey and learn from the winners to Ace all Corporate, Intra Campus, and Inter college competitions.</p>
          <p className={styles.paragraph}>You get a FREE GradUp Handbook to guide you on upcoming competitions and access to 4 winning case study briefs with a solution.</p>
      ...
      <div className={styles.box}>
        <img className={styles.groupimg1} src="/assets/images/commskills.png" alt="interview"></img>
        <div>
          <h1 className={styles.heading}>--Services</h1>
          <h1 className={styles.subhead}>Communication Skills</h1>
          <p className= {styles.paragraph}>Effective communication is a key to success and if you don’t communicate your ideas well, the audience would never be able to connect the impact your idea could bring to the world. Have you ever wondered how these eloquent speakers just move the crowd by their words?</p>
          <p className= {styles.paragraph}>Have you ever noticed some of your college mates with an amazing presentation and communication skills grabbing all the attention even if the point they are trying to make is not impactful enough? That is the magic of communication where you make yourselves heard! Burst the myth now- A person fluent in English does not imply that he/she is a good communicator. Learn the fundamentals of effective communication, listening skills, note making in mind and touching all aspects of a topic via creating a mind tree in just an hour with our mentors.</p>
