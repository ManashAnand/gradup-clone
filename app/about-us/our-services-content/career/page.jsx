    ...
    return(
      ...
      <div className={styles.box}>
        ...
        <div>
          ...
          <p className= 'text-[#17549F] ml-32'>Personal Interview is the Ultimate step in hiring for corporate jobs where candidates are the assessed basis of their technical skills, leadership skills, thinking approach, and many others. We prepare you to step by step to ACE PI for any company you sit for.</p>
      ...
      <div className={styles.box}>
        ...
        <div>
          ...
          <p className= 'text-[#17549F] ml-32'>Being a National Winner in B-School Case Competitions not only adds a star point to your resume but enables you to stand out from the crowd and showcase your real-life problem-solving abilities. Be a part of this 2-hour journey and learn from the winners to Ace all Corporate, Intra Campus, and Inter college competitions.</p>
          <p className= 'text-[#17549F] ml-32'>You get a FREE GradUp Handbook to guide you on upcoming competitions and access to 4 winning case study briefs with a solution.</p>
      ...
      <div className={styles.box}>
        ...
        <div>
          ...
          <p className= 'text-[#17549F] ml-32'>Effective communication is a key to success and if you don’t communicate your ideas well, the audience would never be able to connect the impact your idea could bring to the world. Have you ever wondered how these eloquent speakers just move the crowd by their words?</p>
          <p className= 'text-[#17549F] ml-32'>Have you ever noticed some of your college mates with an amazing presentation and communication skills grabbing all the attention even if the point they are trying to make is not impactful enough? That is the magic of communication where you make yourselves heard! Burst the myth now- A person fluent in English does not imply that he/she is a good communicator. Learn the fundamentals of effective communication, listening skills, note making in mind and touching all aspects of a topic via creating a mind tree in just an hour with our mentors.</p>
