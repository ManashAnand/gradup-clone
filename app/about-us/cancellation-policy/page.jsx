  ...
  return (
    <div className=" w-full my-10">
      ...
      <div className="headingbox2 px-10 pt-10 pb-20">
        ...
        <p className="text-md mb-2 textnew justice text-white">For Gradup Skill Pass, no refund/cancellation would be permitted after payment.</p>
        <p className="text-md mb-2 textnew justice text-white">For GradUp  Student Premium, no refund/cancellation would be permitted after payment.</p>
        <p className="text-md mb-2 textnew justice text-white">For Placement Guarantee courses, no refund/cancellation would be permitted after payment. To claim a refund under the placement guarantee, please refer to the Guaranteed Job/Internship Program in the FAQ of the Placement Guarantee courses.</p>
        <p className="text-md mb-2 textnew justice text-white">For individual fresher job posts and premium internship upgrades, an employer may request a 100% refund within 30 days of their purchase, if they are not able to hire even 1 candidate. The entire amount will be refunded within 15 working days (Monday to Friday, excluding national holidays) of refund request being raised by the user. </p>
        <p className="text-md mb-1 textnew justice text-white">Please note:</p>
        <p className="text-md mb-2 textnew justice text-white">In case of violation of any Terms and Conditions, GradUp  reserves the right to refuse or cancel the refund request.</p>
        <p className="text-md mb-2 textnew justice text-white">Refund isn't available for Premium Plan and bulk plans.</p>
        <p className="text-md mb-2 textnew justice text-white">For advertisers who advertise their products, offerings, and services on different GradUp  channels (Website, Newsletter, Facebook page, other social media channels etc.), no refund/cancellation would be permitted after the advertising campaign has begun or the payment is received, whichever is earlier. If an advertising campaign is cancelled by GradUp due to its internal policies, the advertiser would be entitled to a refund on a pro-rata basis (after deducting the amount for the deliverables already served)</p>
        <p className="text-md mb-2 textnew justice text-white">Not with-standing this policy, any specific terms and conditions mentioned on individual product & service page, and/or as agreed with a user before/during/after the transaction, will override the terms and conditions mentioned here in case of a conflict.</p>
        <p className="text-md mb-2 textnew justice text-white">We may make changes to our products & services, and associated terms & conditions (including terms and conditions on refund and cancellation), from time to time. You are advised to refer to our latest terms and conditions on this page and associated product/service specific terms and conditions page before making a purchase.</p>
      </div>
    </div>
  )
}
