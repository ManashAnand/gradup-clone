  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <p className="text-white text-lg">If for any reason and at any time the Student withdraws from the GradUp Program, then the Student shall be under an obligation to provide the Company and the Company Agent with a prior written notice of 10 (ten) days’ notice of such withdrawal from the GradUp program and the effective date of such withdrawal thereto.</p>
        <br />
