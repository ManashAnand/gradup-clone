        ...
        <form onSubmit={createNewJob} className='w-full'>
          <Grid.Container gap={2} >
            ...
            <Grid xs={12} sm={6}>
              ...
              <label className="text-sm text-white my-3 ml-1">Salary *</label>
              </div>
            ...
            <Grid xs={12} sm={6}>
              ...
              <label className="text-sm text-white my-3 ml-1">Company Name *</label>
              </div>
            ...
            <Grid xs={12} sm={6}>
              ...
              <label className="text-sm text-white my-3 ml-1">Duration</label>
              </div>
            ...
            <label className="text-sm text-white mt-3 ml-1">Eligibility *</label>
            </div>
            <Textarea
            ...
            <Grid xs={12} sm={4}>
              ...
              <label className="text-sm text-white my-3 ml-1">Last Date to Apply *</label>
              </div>
            ...
            <Grid xs={12} sm={4}>
              ...
              <div className="flex">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{fill: "white",marginTop:"1.6vh",marginLeft:"0.6em"}}><path d="M7 11h2v2H7zm0 4h2v2H7zm4-4h2v2h-2zm0 4h2v2h-2zm4-4h2v2h-2zm0 4h2v2h-2z"></path><path d="M5 22h14c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2h-2V2h-2v2H9V2H7v2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2zM19 8l.001 12H5V8h14z"></path></svg>
              <label className="text-sm text-white my-3 ml-1">Expected Start Date</label>
              </div>
            ...
            <Grid xs={12} sm={4}>
              ...
              <label className="text-sm text-white my-3 ml-1">No. of Openings *</label>
              </div>
            ...
            <label className="text-sm text-white mt-8 ml-1">Job Description *</label>
            </div>
            <Textarea
              css={{mt:"$5",backgroundColor:"$white"}}
              rows='10'
            ...
            <label className="text-sm text-white mt-8 ml-1">Responsibilities *</label>
            </div>
            <Textarea
              css={{mt:"$5",backgroundColor:"$white"}}
              rows='10'
          ...
          {/* <Textarea
              ...
              placeholder="Description of the Job"
            /> */}
          <button type='submit' className='py-2 px-10 rounded-xl bg-white ml-6 mt-4 border-sky-800 border-2 hover:bg-white hover:text-blue-500 hover:border-blue-600'  >Submit</button>
        </form>
    </div>
