    ...
    <>
      {!posted ? (
          ...
          <form onSubmit={createNewJob} className='w-full'>
            <Grid.Container gap={2}>
              ...
              <Grid xs={12} sm={6}>
                <div className='flex flex-col mx-auto w-full'>
                  <div className='flex'>
                    ...
                    <label className=' text-white my-3 ml-1'>
                      {value === true ? 'Stipend *' : 'Salary (per month)*'}
                    </label>
                  </div>
                  <input
                    type='number'
                    className='rounded-md p-2'
                    css={{ backgroundColor: '$white' }}
                    placeholder={value === true ? 'Stipend' : 'Salary'}
                    initialValue=''
                    required
                  />
                </div>
              ...
              <div className='flex flex-col mx-auto w-full'>
                <div className='flex'>
                  ...
                  <label className=' text-white mt-9 ml-1'>
                    {value ? "Intern's Responsibilities" : 'Job Description*'}
                  </label>
                </div>
                <Textarea
            ...
            <a href='#'>
              <button
                ...
                className='py-2 px-10 float-left rounded-xl bg-white ml-3 mt-7 border-sky-800 border-2 hover:bg-white hover:text-blue-500 hover:border-blue-600'
              >
                Submit
              </button>
            </a>
        ...
        <div className='flex flex-col justify-center items-center my-32'>
          ...
          <p className='text-4xl text text-lime-500 mb-4'>
            Successfully published the job.
          </p>
          <p className='text-white'>
            Check the dashboard for tracking the application.
          </p>
          <div className='flex justify-center'>
            <a href='/hr/posted-jobs'>
              <button className='px-5 py-2 rounded-md bg-white text-blue-500 mt-5'>
                Go to Dashboard
              </button>
            </a>
          </div>
