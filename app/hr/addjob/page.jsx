        ...
        <form onSubmit={createNewJob} className='w-full'>
          <Grid.Container gap={2} >
            <Grid xs={12} sm={6}>
              ...
              <Input css={{backgroundColor:"$white"}} clearable placeholder="Job Title" initialValue="" required/>
              </div>
            </Grid>
            <Grid xs={12} sm={6}>
              <div className="flex flex-col mx-auto w-full">
              ...
              <Input css={{backgroundColor:"$white"}} clearable  placeholder="Stipend" initialValue="" required/>
              </div>
            </Grid>
            <Grid xs={12} sm={6}>
              <div className="flex flex-col mx-auto w-full">
              ...
              <Input css={{backgroundColor:"$white"}} clearable  placeholder="Company Name" initialValue="" required/>
              </div>
            </Grid>
            <Grid xs={12} sm={6}>
              <div className="flex flex-col mx-auto w-full">
              ...
              <Input css={{backgroundColor:"$white"}} clearable  placeholder="Duration" initialValue="" />
              </div>
            </Grid>
            <div className="flex flex-col mx-auto w-full">
            <div className="flex">
            ...
            <Grid xs={12} sm={4}>
              ...
              <Input type="date" css={{backgroundColor:"$white"}} clearable  Placeholder="Last Date to apply" initialValue=""/>
              </div>
            </Grid>
            <Grid xs={12} sm={4}>
              <div className="flex flex-col mx-auto w-full">
              ...
              <Input type="date" css={{backgroundColor:"$white"}} clearable  Placeholder="Expected Start Date" initialValue=""/>
              </div>
            </Grid>
            <Grid xs={12} sm={4}>
              <div className="flex flex-col mx-auto w-full">
              ...
              <Input type="number" css={{backgroundColor:"$white"}} clearable  Placeholder="No. of Openings" initialValue="" required/>
              </div>
            </Grid>
            <Grid xs={12} sm={12}>
              <div className="flex flex-col mx-auto w-full">
              ...
              <Input css={{backgroundColor:"$white"}} clearable  Placeholder="Skills" initialValue="" required/>
              </div>
            </Grid>
            <div className="flex flex-col mx-auto w-full">
            <div className="flex">
          ...
          {/* <Grid.Container gap={2} >
            <Input clearable  label="Job Title" Placeholder="Job Title" initialValue="" />
            <Spacer y={0.5} />
            <Input clearable  label="Stipend" Placeholder="Stipend" initialValue="" />
            <Spacer x={0.5} />
          </Grid.Container> */}
          {/* <Textarea
