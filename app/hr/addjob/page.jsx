        ...
        <form onSubmit={createNewJob} className='w-full'>
          <Grid.Container gap={2} >
            ...
            <Grid xs={12} sm={6}>
              ...
              <label className="text-sm text-white my-3 ml-1">Stipend</label>
              </div>
            ...
            <Grid xs={12} sm={4}>
              ...
              <input className="rounded-md p-2" type="date" css={{backgroundColor:"$white"}} clearable  Placeholder="Last Date to apply" initialValue=""/>
              </div>
            </Grid>
            <Grid xs={12} sm={4}>
              <div className="flex flex-col mx-auto w-full">
