    ...
    <div className='justify-center w-full align-center justify-items-center hrjobs'>
        ...
        <form onSubmit={createNewJob} className='w-full'>
          <Grid.Container gap={2} >
            ...
            <div className="flex flex-col mx-auto w-full">
            <div className="flex">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{fill: "grey",marginTop:"1.6vh",marginLeft:"1em"}} ><path d="m2.394 13.742 4.743 3.62 7.616-8.704-1.506-1.316-6.384 7.296-3.257-2.486zm19.359-5.084-1.506-1.316-6.369 7.279-.753-.602-1.25 1.562 2.247 1.798z"></path></svg>
            <label className="text-sm mt-3 ml-2">Eligibility</label>
            </div>
            <Textarea
