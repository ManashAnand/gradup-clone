      ...
      <ul class="space-y-2 font-medium ">
         ...
         <li>
            <Link href="#" class="flex items-center p-2 text-gray-900 rounded-lg text-black group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap text-left">Applied Jobs</span>
            </Link>
         </li>
         <li>
            <Link href="#" class="flex items-center p-2 text-gray-900 rounded-lg text-black group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap text-left">Purchased Courses</span>
            </Link>
         </li>
         <li>
            <Link href="#" class="flex items-center p-2 text-gray-900 rounded-lg text-black group">
         ...
         <li>
            <Link href="#" class="flex items-center p-2 text-gray-900 rounded-lg text-black group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap text-left">Applied Hackathons</span>
            </Link>
         </li>
      ...
      <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
        ...
        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
               ...
               <span class="flex-1 ms-3 whitespace-nowrap text-left">Applied Internships</span>
                ...
                <div className=" w-4/5 flex justify-between items-center  mt-4 ">
                    ...
                    <div className="w-64 bg-[#FCF4D7] text-black h-28 rounded-md flex flex-col justify-center items-center">
                        <div className="text-black">Shortlisted</div>
                    ...
                    <div className="w-64 bg-[#EFE0FD] text-black h-28 rounded-md flex flex-col justify-center items-center">
                        <div className="text-black">Interview</div>
            ...
            <footer class="bg-white  w-full">
                ...
                <div>
    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase text-left">Company Profile</h2>
    <ul class="text-gray-500 dark:text-gray-400 font-medium text-left">
        <li class="mb-4">
            <a href="#" class="hover:underline">ABC Tech Solutions</a>
        </li>
        <li class="mb-4">
            <a href="#" class="hover:underline">XYZ Marketing Group</a>
        </li>
        <li class="mb-4">
            <a href="#" class="hover:underline">Global Innovations Inc.</a>
        </li>
        <li class="mb-4">
            <a href="#" class="hover:underline">Digital Ventures Ltd.</a>
        </li>
        <li class="mb-4">
            <a href="#" class="hover:underline">Tech Innovators Co.</a>
        </li>
    </ul>
</div>
<div>
...
<div>
    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase text-left ">Salary</h2>
    <ul class="text-gray-500 dark:text-gray-400 font-medium text-left">
        <li class="mb-4">
            <a href="#" class="hover:underline">$70,000 per year</a>
        </li>
        <li class="mb-4">
            <a href="#" class="hover:underline">$60,000 per year</a>
        </li>
        <li class="mb-4">
            <a href="#" class="hover:underline">$80,000 per year</a>
        </li>
        <li class="mb-4">
            <a href="#" class="hover:underline">$75,000 per year</a>
        </li>
        <li class="mb-4">
            <a href="#" class="hover:underline">$90,000 per year</a>
        </li>
    </ul>
</div>
<div>
    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase text-left ">Status</h2>
    <ul class="text-gray-500 dark:text-gray-400 font-medium text-left">
        <li class="mb-4">
            <a href="#" class="hover:underline">Pending</a>
        </li>
        <li class="mb-4">
            <a href="#" class="hover:underline">Reviewed</a>
        </li>
        <li class="mb-4">
            <a href="#" class="hover:underline">Interview Scheduled</a>
        </li>
        <li class="mb-4">
            <a href="#" class="hover:underline">Offer Extended</a>
        </li>
        <li class="mb-4">
            <a href="#" class="hover:underline">Hired</a>
        </li>
    </ul>
</div>
