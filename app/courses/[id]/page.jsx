    ...
    return (
      <>
        ...
        <div className=' text-black  w-screen bg-white p-8'>
          ...
          <div className='  sm:flex mb-6 sm:mb-2 justify-between mt-5'>
            <div className='text-white h-full sm:w-[50%] w-full bg-[#041E48] rounded-md mb-2 p-6'>
          ...
          <div class='shadow p-5 rounded-lg  bg-[#F7F9FC] my-4 '>
            ...
            <div className='flex ml-[2%] mb-4 text-left'>
