  ...
  return (
    <section className='w-full flex-center flex-col'>
        ...
        <div className='p-10 w-screen bg-white'>
          <div className="hide1">
          <p className='text-xl font-semibold mt-6 text-sky-700 ml-32 text'>Get Hired</p>
          <p className='text-gray-700 ml-32 text'>Work with your dream companies by applying for full-time roles and internships and Hackathon too.</p>
          </div>
