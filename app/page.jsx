    ...
    <section className='w-full flex-center flex-col'>
        ...
        <div className="w-screen databox">
          <div className="filter"></div>
           ...
           <p className='textnew'>The best quality online courses from institutions</p>
           </div>
        </div>
        <div style={{background:"linear-gradient(220deg, #044E83 0%, rgba(4, 78, 131, 0.98) 10.32%, rgba(4, 78, 131, 0.97) 17.79%, rgba(4, 78, 131, 0.96) 27.13%, rgba(4, 78, 131, 0.95) 60.90%, rgba(199, 95, 189, 0.94) 99.86%)"}} className='p-10 w-screen'>
          <div className="hide1">
