          ...
          <div className=' w-full text-left'>
            ...
            <p className='text-white textnew w-4/5 mb-2'>
              * The Default Resume will be considered for the Job Application.
              If you haven't filled your resume yet, Please click the below
              button to proceed.
            </p>
            ...
            <a href='/user'>
              <button className='px-16 py-2 bg-sky-500 text-white textnew rounded-md text-left mb-10'>
                My Resume
              </button>
            </a>
            ...
            <form onSubmit={createApplication} className='w-4/5 justify-center'>
              ...
              <button
                ...
                onClick={handleClick}
                className='bg-sky-400 mb-16 text-white rounded-md px-10 py-2 text-sm hover:bg-white hover:text-sky-400 mt-3'
              >
                Submit
              </button>
            </form>
