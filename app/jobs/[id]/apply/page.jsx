          ...
          <div className=' w-full text-left'>
            ...
            <p className='text-white textnew w-4/5 mb-2'>
              * The Default Resume will be considered for the Job Application.
              If you haven't created your resume yet, Please complete your resume to proceed.
            </p>
            ...
            <form onSubmit={createApplication} className='w-4/5 justify-center'>
              ...
              <input checked={checked} type='checkbox' className='w-6 h-6' onChange={handleCheck} />
              ...
              <br></br>
              <a href='/user'>
              <button className='mr-10 px-16 py-2 bg-sky-500 text-white textnew rounded-md text-left mb-10'>
                Create your resume
              </button>
            </a>
            <a href='/user'>
