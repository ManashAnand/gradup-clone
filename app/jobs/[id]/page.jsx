  ...
  const jobs=data
    return (
        <section className='w-full'>
          <h1 className='mt-4 font-bold text-xl text-left'>
          ...
          <div className='w-full'>
              <section>
                <section >
                  ...
                  <label className="ml-1 mb-1 text-sm text-gray-600 font-semibold">Job Title</label>
                  </div>
                  <input className="py-1 px-5 text-sm bg-white text-gray-600 rounded-md border-blue-300 border-2 max-w-xs" value={jobs.title}></input>
                  <div className="flex mb-1">
                  ...
                  <label className="ml-1 mb-1 mt-4 text-sm text-gray-600 font-semibold">Company Name</label>
                  </div>
                  <input className="py-1 px-5 text-sm bg-white text-gray-600 rounded-md border-blue-300 border-2 max-w-xs" value={jobs.companyName}></input>
                  <div className="flex mb-1">
                  ...
                  <label className="ml-1 mb-1 mt-4 text-sm text-gray-600 font-semibold">Salary</label>
                  </div>
                  <input className="py-1 px-5 text-sm bg-white text-gray-600 rounded-md border-blue-300 border-2 max-w-xs" value={jobs.stipend}></input>
                  <div className="flex mb-1">
                  ...
                  <label className="ml-1 mb-1 mt-4 text-sm text-gray-600 font-semibold">Last Date to Apply</label>
                  </div>
                  <input className="py-1 px-5 text-sm bg-white text-gray-600 rounded-md border-blue-300 border-2 max-w-xs" value={jobs.lastDate}></input>
                  <div className="flex mb-1">
                  ...
                  <label className="ml-1 mb-1 mt-4 text-sm text-gray-600 font-semibold">No. of Openings</label>
                  </div>
                  <input className="py-1 px-5 text-sm bg-white text-gray-600 rounded-md border-blue-300 border-2 max-w-xs" value={jobs.noOfOpenings}></input>
                  <div className="flex mb-1">
                  ...
                  <label className="ml-1 mb-1 mt-4 text-sm text-gray-600 font-semibold">Skills Required</label>
                  </div>
                  ...
                  <label className="ml-1 mb-1 mt-4 text-sm text-gray-600 font-semibold">Roles and Responsibilities</label>
                  </div>
