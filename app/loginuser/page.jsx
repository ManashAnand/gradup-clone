...
const Login = () => {
  ...
  return (
    <>
    <h1 className='flex justify-center font-bold text-3xl my-6 text-white'>Welcome back</h1>
    <form action="">
    ...
    <button type='button' onClick={() => { signIn("google")}} className="btn border bg-green-600 text-white px-4 py-2 rounded-lg my-1 mx-auto"><GoogleIcon/> &nbsp; Login with Google</button>
    <button type='button' onClick={() => { signIn("github")}}  className="btn border bg-gray-600 text-white px-4 py-2 rounded-lg my-1 mx-auto"><GitHubIcon/> &nbsp;Login with GitHub</button>
    <button type='button' onClick={() => { signIn("twitter")}}  className="btn border bg-blue-400 text-white px-4 py-2 rounded-lg my-1 mx-auto"><TwitterIcon/> &nbsp;Login with Twitter</button>
    </div>
    </>
  )
}
